...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    public final synchronized okhttp3.internal.cache.DiskLruCache.Snapshot get(java.lang.String r8) throws java.io.IOException {
        /*
            ...
            r7.checkNotClosed()     // Catch:{ all -> 0x0061 }
            r7.validateKey(r8)     // Catch:{ all -> 0x0061 }
            java.util.LinkedHashMap<java.lang.String, okhttp3.internal.cache.DiskLruCache$Entry> r0 = r7.lruEntries     // Catch:{ all -> 0x0061 }
            java.lang.Object r0 = r0.get(r8)     // Catch:{ all -> 0x0061 }
            okhttp3.internal.cache.DiskLruCache$Entry r0 = (okhttp3.internal.cache.DiskLruCache.Entry) r0     // Catch:{ all -> 0x0061 }
            r1 = 0
            ...
            okhttp3.internal.cache.DiskLruCache$Snapshot r0 = r0.snapshot$okhttp()     // Catch:{ all -> 0x0061 }
            if (r0 == 0) goto L_0x005d
            int r1 = r7.redundantOpCount     // Catch:{ all -> 0x0061 }
            int r1 = r1 + 1
            r7.redundantOpCount = r1     // Catch:{ all -> 0x0061 }
            okio.BufferedSink r1 = r7.journalWriter     // Catch:{ all -> 0x0061 }
        ...
        L_0x0032:
            ...
            boolean r8 = r7.journalRebuildRequired()     // Catch:{ all -> 0x0061 }
            if (r8 == 0) goto L_0x005b
            okhttp3.internal.concurrent.TaskQueue r1 = r7.cleanupQueue     // Catch:{ all -> 0x0061 }
            okhttp3.internal.cache.DiskLruCache$cleanupTask$1 r8 = r7.cleanupTask     // Catch:{ all -> 0x0061 }
            r2 = r8
            okhttp3.internal.concurrent.Task r2 = (okhttp3.internal.concurrent.Task) r2     // Catch:{ all -> 0x0061 }
            r3 = 0
            r5 = 2
            r6 = 0
            okhttp3.internal.concurrent.TaskQueue.schedule$default(r1, r2, r3, r5, r6)     // Catch:{ all -> 0x0061 }
        L_0x005b:
            monitor-exit(r7)
            return r0
        L_0x005d:
    ...
    public final synchronized okhttp3.internal.cache.DiskLruCache.Editor edit(java.lang.String r11, long r12) throws java.io.IOException {
        /*
            ...
            r10.checkNotClosed()     // Catch:{ all -> 0x0096 }
            r10.validateKey(r11)     // Catch:{ all -> 0x0096 }
            java.util.LinkedHashMap<java.lang.String, okhttp3.internal.cache.DiskLruCache$Entry> r0 = r10.lruEntries     // Catch:{ all -> 0x0096 }
            java.lang.Object r0 = r0.get(r11)     // Catch:{ all -> 0x0096 }
            okhttp3.internal.cache.DiskLruCache$Entry r0 = (okhttp3.internal.cache.DiskLruCache.Entry) r0     // Catch:{ all -> 0x0096 }
            long r1 = ANY_SEQUENCE_NUMBER     // Catch:{ all -> 0x0096 }
            r3 = 0
            int r4 = (r12 > r1 ? 1 : (r12 == r1 ? 0 : -1))
            if (r4 == 0) goto L_0x002a
            if (r0 == 0) goto L_0x0028
            long r1 = r0.getSequenceNumber$okhttp()     // Catch:{ all -> 0x0096 }
        ...
        L_0x002a:
            ...
            okhttp3.internal.cache.DiskLruCache$Editor r12 = r0.getCurrentEditor$okhttp()     // Catch:{ all -> 0x0096 }
            goto L_0x0032
        L_0x0031:
            r12 = r3
        L_0x0032:
        ...
        L_0x0036:
            ...
            int r12 = r0.getLockingSourceCount$okhttp()     // Catch:{ all -> 0x0096 }
            if (r12 == 0) goto L_0x0040
            monitor-exit(r10)
            return r3
        L_0x0040:
            boolean r12 = r10.mostRecentTrimFailed     // Catch:{ all -> 0x0096 }
            if (r12 != 0) goto L_0x0086
            boolean r12 = r10.mostRecentRebuildFailed     // Catch:{ all -> 0x0096 }
            if (r12 == 0) goto L_0x0049
            goto L_0x0086
        L_0x0049:
            okio.BufferedSink r12 = r10.journalWriter     // Catch:{ all -> 0x0096 }
        ...
        L_0x0050:
            ...
            boolean r12 = r10.hasJournalErrors     // Catch:{ all -> 0x0096 }
            if (r12 == 0) goto L_0x006e
            monitor-exit(r10)
            return r3
        L_0x006e:
            if (r0 != 0) goto L_0x007c
            okhttp3.internal.cache.DiskLruCache$Entry r0 = new okhttp3.internal.cache.DiskLruCache$Entry     // Catch:{ all -> 0x0096 }
            r0.<init>(r10, r11)     // Catch:{ all -> 0x0096 }
            java.util.LinkedHashMap<java.lang.String, okhttp3.internal.cache.DiskLruCache$Entry> r12 = r10.lruEntries     // Catch:{ all -> 0x0096 }
            java.util.Map r12 = (java.util.Map) r12     // Catch:{ all -> 0x0096 }
            r12.put(r11, r0)     // Catch:{ all -> 0x0096 }
        L_0x007c:
            okhttp3.internal.cache.DiskLruCache$Editor r11 = new okhttp3.internal.cache.DiskLruCache$Editor     // Catch:{ all -> 0x0096 }
            r11.<init>(r10, r0)     // Catch:{ all -> 0x0096 }
            r0.setCurrentEditor$okhttp(r11)     // Catch:{ all -> 0x0096 }
            monitor-exit(r10)
            return r11
        L_0x0086:
            okhttp3.internal.concurrent.TaskQueue r4 = r10.cleanupQueue     // Catch:{ all -> 0x0096 }
            okhttp3.internal.cache.DiskLruCache$cleanupTask$1 r11 = r10.cleanupTask     // Catch:{ all -> 0x0096 }
            r5 = r11
            okhttp3.internal.concurrent.Task r5 = (okhttp3.internal.concurrent.Task) r5     // Catch:{ all -> 0x0096 }
            r6 = 0
            r8 = 2
            r9 = 0
            okhttp3.internal.concurrent.TaskQueue.schedule$default(r4, r5, r6, r8, r9)     // Catch:{ all -> 0x0096 }
            monitor-exit(r10)
            return r3
        L_0x0096:
            r11 = move-exception
    ...
    public final synchronized void completeEdit$okhttp(okhttp3.internal.cache.DiskLruCache.Editor r9, boolean r10) throws java.io.IOException {
        /*
            ...
            kotlin.jvm.internal.Intrinsics.checkParameterIsNotNull(r9, r0)     // Catch:{ all -> 0x014f }
            okhttp3.internal.cache.DiskLruCache$Entry r0 = r9.getEntry$okhttp()     // Catch:{ all -> 0x014f }
            okhttp3.internal.cache.DiskLruCache$Editor r1 = r0.getCurrentEditor$okhttp()     // Catch:{ all -> 0x014f }
            boolean r1 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r1, (java.lang.Object) r9)     // Catch:{ all -> 0x014f }
            if (r1 == 0) goto L_0x0141
            r1 = 0
            if (r10 == 0) goto L_0x0065
            boolean r2 = r0.getReadable$okhttp()     // Catch:{ all -> 0x014f }
            if (r2 != 0) goto L_0x0065
            int r2 = r8.valueCount     // Catch:{ all -> 0x014f }
            r3 = 0
        L_0x0020:
            if (r3 >= r2) goto L_0x0065
            boolean[] r4 = r9.getWritten$okhttp()     // Catch:{ all -> 0x014f }
            if (r4 != 0) goto L_0x002b
            kotlin.jvm.internal.Intrinsics.throwNpe()     // Catch:{ all -> 0x014f }
        L_0x002b:
            boolean r4 = r4[r3]     // Catch:{ all -> 0x014f }
            if (r4 == 0) goto L_0x0049
            okhttp3.internal.io.FileSystem r4 = r8.fileSystem     // Catch:{ all -> 0x014f }
            java.util.List r5 = r0.getDirtyFiles$okhttp()     // Catch:{ all -> 0x014f }
            java.lang.Object r5 = r5.get(r3)     // Catch:{ all -> 0x014f }
            java.io.File r5 = (java.io.File) r5     // Catch:{ all -> 0x014f }
            boolean r4 = r4.exists(r5)     // Catch:{ all -> 0x014f }
            if (r4 != 0) goto L_0x0046
            r9.abort()     // Catch:{ all -> 0x014f }
            monitor-exit(r8)
            return
        L_0x0046:
            int r3 = r3 + 1
        ...
        L_0x0049:
            r9.abort()     // Catch:{ all -> 0x014f }
            java.lang.IllegalStateException r9 = new java.lang.IllegalStateException     // Catch:{ all -> 0x014f }
            java.lang.StringBuilder r10 = new java.lang.StringBuilder     // Catch:{ all -> 0x014f }
            r10.<init>()     // Catch:{ all -> 0x014f }
            java.lang.String r0 = "Newly created entry didn't create value for index "
            r10.append(r0)     // Catch:{ all -> 0x014f }
            r10.append(r3)     // Catch:{ all -> 0x014f }
            java.lang.String r10 = r10.toString()     // Catch:{ all -> 0x014f }
            r9.<init>(r10)     // Catch:{ all -> 0x014f }
            java.lang.Throwable r9 = (java.lang.Throwable) r9     // Catch:{ all -> 0x014f }
            throw r9     // Catch:{ all -> 0x014f }
        L_0x0065:
            int r9 = r8.valueCount     // Catch:{ all -> 0x014f }
        L_0x0067:
            if (r1 >= r9) goto L_0x00b3
            java.util.List r2 = r0.getDirtyFiles$okhttp()     // Catch:{ all -> 0x014f }
            java.lang.Object r2 = r2.get(r1)     // Catch:{ all -> 0x014f }
            java.io.File r2 = (java.io.File) r2     // Catch:{ all -> 0x014f }
            if (r10 == 0) goto L_0x00ab
            boolean r3 = r0.getZombie$okhttp()     // Catch:{ all -> 0x014f }
            if (r3 != 0) goto L_0x00ab
            okhttp3.internal.io.FileSystem r3 = r8.fileSystem     // Catch:{ all -> 0x014f }
            boolean r3 = r3.exists(r2)     // Catch:{ all -> 0x014f }
            if (r3 == 0) goto L_0x00b0
            java.util.List r3 = r0.getCleanFiles$okhttp()     // Catch:{ all -> 0x014f }
            java.lang.Object r3 = r3.get(r1)     // Catch:{ all -> 0x014f }
            java.io.File r3 = (java.io.File) r3     // Catch:{ all -> 0x014f }
            okhttp3.internal.io.FileSystem r4 = r8.fileSystem     // Catch:{ all -> 0x014f }
            r4.rename(r2, r3)     // Catch:{ all -> 0x014f }
            long[] r2 = r0.getLengths$okhttp()     // Catch:{ all -> 0x014f }
            r4 = r2[r1]     // Catch:{ all -> 0x014f }
            okhttp3.internal.io.FileSystem r2 = r8.fileSystem     // Catch:{ all -> 0x014f }
            long r2 = r2.size(r3)     // Catch:{ all -> 0x014f }
            long[] r6 = r0.getLengths$okhttp()     // Catch:{ all -> 0x014f }
            r6[r1] = r2     // Catch:{ all -> 0x014f }
            long r6 = r8.size     // Catch:{ all -> 0x014f }
            long r6 = r6 - r4
            long r6 = r6 + r2
            r8.size = r6     // Catch:{ all -> 0x014f }
            goto L_0x00b0
        L_0x00ab:
            okhttp3.internal.io.FileSystem r3 = r8.fileSystem     // Catch:{ all -> 0x014f }
            r3.delete(r2)     // Catch:{ all -> 0x014f }
        L_0x00b0:
            int r1 = r1 + 1
            goto L_0x0067
        L_0x00b3:
            r9 = 0
            okhttp3.internal.cache.DiskLruCache$Editor r9 = (okhttp3.internal.cache.DiskLruCache.Editor) r9     // Catch:{ all -> 0x014f }
            r0.setCurrentEditor$okhttp(r9)     // Catch:{ all -> 0x014f }
            boolean r9 = r0.getZombie$okhttp()     // Catch:{ all -> 0x014f }
            if (r9 == 0) goto L_0x00c4
            r8.removeEntry$okhttp(r0)     // Catch:{ all -> 0x014f }
            monitor-exit(r8)
            return
        L_0x00c4:
            int r9 = r8.redundantOpCount     // Catch:{ all -> 0x014f }
            r1 = 1
            int r9 = r9 + r1
            r8.redundantOpCount = r9     // Catch:{ all -> 0x014f }
            okio.BufferedSink r9 = r8.journalWriter     // Catch:{ all -> 0x014f }
        ...
        L_0x00d1:
            ...
            goto L_0x00fb
        L_0x00de:
            java.util.LinkedHashMap<java.lang.String, okhttp3.internal.cache.DiskLruCache$Entry> r10 = r8.lruEntries     // Catch:{ all -> 0x014f }
            java.lang.String r1 = r0.getKey$okhttp()     // Catch:{ all -> 0x014f }
            r10.remove(r1)     // Catch:{ all -> 0x014f }
            java.lang.String r10 = REMOVE     // Catch:{ all -> 0x014f }
            okio.BufferedSink r10 = r9.writeUtf8(r10)     // Catch:{ all -> 0x014f }
            r10.writeByte(r4)     // Catch:{ all -> 0x014f }
            java.lang.String r10 = r0.getKey$okhttp()     // Catch:{ all -> 0x014f }
            r9.writeUtf8(r10)     // Catch:{ all -> 0x014f }
            r9.writeByte(r3)     // Catch:{ all -> 0x014f }
            goto L_0x0120
        L_0x00fb:
            r0.setReadable$okhttp(r1)     // Catch:{ all -> 0x014f }
            java.lang.String r1 = CLEAN     // Catch:{ all -> 0x014f }
            okio.BufferedSink r1 = r9.writeUtf8(r1)     // Catch:{ all -> 0x014f }
            r1.writeByte(r4)     // Catch:{ all -> 0x014f }
            java.lang.String r1 = r0.getKey$okhttp()     // Catch:{ all -> 0x014f }
            r9.writeUtf8(r1)     // Catch:{ all -> 0x014f }
            r0.writeLengths$okhttp(r9)     // Catch:{ all -> 0x014f }
            r9.writeByte(r3)     // Catch:{ all -> 0x014f }
            if (r10 == 0) goto L_0x0120
            long r1 = r8.nextSequenceNumber     // Catch:{ all -> 0x014f }
            r3 = 1
            long r3 = r3 + r1
            r8.nextSequenceNumber = r3     // Catch:{ all -> 0x014f }
            r0.setSequenceNumber$okhttp(r1)     // Catch:{ all -> 0x014f }
        L_0x0120:
            r9.flush()     // Catch:{ all -> 0x014f }
            long r9 = r8.size     // Catch:{ all -> 0x014f }
            long r0 = r8.maxSize     // Catch:{ all -> 0x014f }
            int r2 = (r9 > r0 ? 1 : (r9 == r0 ? 0 : -1))
            if (r2 > 0) goto L_0x0131
            boolean r9 = r8.journalRebuildRequired()     // Catch:{ all -> 0x014f }
            if (r9 == 0) goto L_0x013f
        L_0x0131:
            okhttp3.internal.concurrent.TaskQueue r0 = r8.cleanupQueue     // Catch:{ all -> 0x014f }
            okhttp3.internal.cache.DiskLruCache$cleanupTask$1 r9 = r8.cleanupTask     // Catch:{ all -> 0x014f }
            r1 = r9
            okhttp3.internal.concurrent.Task r1 = (okhttp3.internal.concurrent.Task) r1     // Catch:{ all -> 0x014f }
            r2 = 0
            r4 = 2
            r5 = 0
            okhttp3.internal.concurrent.TaskQueue.schedule$default(r0, r1, r2, r4, r5)     // Catch:{ all -> 0x014f }
        L_0x013f:
            monitor-exit(r8)
            return
        L_0x0141:
            java.lang.String r9 = "Check failed."
            java.lang.IllegalStateException r10 = new java.lang.IllegalStateException     // Catch:{ all -> 0x014f }
            java.lang.String r9 = r9.toString()     // Catch:{ all -> 0x014f }
            r10.<init>(r9)     // Catch:{ all -> 0x014f }
            java.lang.Throwable r10 = (java.lang.Throwable) r10     // Catch:{ all -> 0x014f }
