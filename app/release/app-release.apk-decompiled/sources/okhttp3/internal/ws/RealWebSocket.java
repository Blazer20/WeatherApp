...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:67:0x0182, code lost:
        if (((okhttp3.internal.ws.RealWebSocket.Streams) r1.element) == null) goto L_0x019b;
     */
    ...
    public final boolean writeOneFrame$okhttp() throws java.io.IOException {
        /*
            ...
            r10.element = r3
            monitor-enter(r27)
            boolean r3 = r15.failed     // Catch:{ all -> 0x020f }
            r4 = 0
            if (r3 == 0) goto L_0x0042
            monitor-exit(r27)
            return r4
        L_0x0042:
            okhttp3.internal.ws.WebSocketWriter r9 = r15.writer     // Catch:{ all -> 0x020f }
            java.util.ArrayDeque<okio.ByteString> r3 = r15.pongQueue     // Catch:{ all -> 0x020f }
            java.lang.Object r3 = r3.poll()     // Catch:{ all -> 0x020f }
            r8 = r3
            okio.ByteString r8 = (okio.ByteString) r8     // Catch:{ all -> 0x020f }
            if (r8 != 0) goto L_0x0101
            java.util.ArrayDeque<java.lang.Object> r3 = r15.messageAndCloseQueue     // Catch:{ all -> 0x020f }
            java.lang.Object r3 = r3.poll()     // Catch:{ all -> 0x020f }
            r0.element = r3     // Catch:{ all -> 0x020f }
            T r3 = r0.element     // Catch:{ all -> 0x020f }
            boolean r3 = r3 instanceof okhttp3.internal.ws.RealWebSocket.Close     // Catch:{ all -> 0x020f }
            if (r3 == 0) goto L_0x00ed
            int r3 = r15.receivedCloseCode     // Catch:{ all -> 0x020f }
            r14.element = r3     // Catch:{ all -> 0x020f }
            java.lang.String r3 = r15.receivedCloseReason     // Catch:{ all -> 0x020f }
            r13.element = r3     // Catch:{ all -> 0x020f }
            int r3 = r14.element     // Catch:{ all -> 0x020f }
            if (r3 == r2) goto L_0x008a
            okhttp3.internal.ws.RealWebSocket$Streams r2 = r15.streams     // Catch:{ all -> 0x020f }
            r12.element = r2     // Catch:{ all -> 0x020f }
            r2 = r1
            okhttp3.internal.ws.RealWebSocket$Streams r2 = (okhttp3.internal.ws.RealWebSocket.Streams) r2     // Catch:{ all -> 0x020f }
            r15.streams = r2     // Catch:{ all -> 0x020f }
            okhttp3.internal.ws.WebSocketReader r2 = r15.reader     // Catch:{ all -> 0x020f }
            r11.element = r2     // Catch:{ all -> 0x020f }
            r2 = r1
            okhttp3.internal.ws.WebSocketReader r2 = (okhttp3.internal.ws.WebSocketReader) r2     // Catch:{ all -> 0x020f }
            r15.reader = r2     // Catch:{ all -> 0x020f }
            okhttp3.internal.ws.WebSocketWriter r2 = r15.writer     // Catch:{ all -> 0x020f }
            r10.element = r2     // Catch:{ all -> 0x020f }
            okhttp3.internal.ws.WebSocketWriter r1 = (okhttp3.internal.ws.WebSocketWriter) r1     // Catch:{ all -> 0x020f }
            r15.writer = r1     // Catch:{ all -> 0x020f }
            okhttp3.internal.concurrent.TaskQueue r1 = r15.taskQueue     // Catch:{ all -> 0x020f }
            r1.shutdown()     // Catch:{ all -> 0x020f }
            goto L_0x0101
        L_0x008a:
            T r1 = r0.element     // Catch:{ all -> 0x020f }
            if (r1 == 0) goto L_0x00e5
            okhttp3.internal.ws.RealWebSocket$Close r1 = (okhttp3.internal.ws.RealWebSocket.Close) r1     // Catch:{ all -> 0x020f }
            long r1 = r1.getCancelAfterCloseMillis()     // Catch:{ all -> 0x020f }
            okhttp3.internal.concurrent.TaskQueue r7 = r15.taskQueue     // Catch:{ all -> 0x020f }
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch:{ all -> 0x020f }
            r3.<init>()     // Catch:{ all -> 0x020f }
            java.lang.String r4 = r15.name     // Catch:{ all -> 0x020f }
            r3.append(r4)     // Catch:{ all -> 0x020f }
            java.lang.String r4 = " cancel"
            r3.append(r4)     // Catch:{ all -> 0x020f }
            java.lang.String r4 = r3.toString()     // Catch:{ all -> 0x020f }
            java.util.concurrent.TimeUnit r3 = java.util.concurrent.TimeUnit.MILLISECONDS     // Catch:{ all -> 0x020f }
            long r5 = r3.toNanos(r1)     // Catch:{ all -> 0x020f }
            r16 = 1
            okhttp3.internal.ws.RealWebSocket$writeOneFrame$$inlined$synchronized$lambda$1 r17 = new okhttp3.internal.ws.RealWebSocket$writeOneFrame$$inlined$synchronized$lambda$1     // Catch:{ all -> 0x020f }
            r1 = r17
            r2 = r4
            r3 = r16
            r18 = r5
            ...
            r26 = r14
            r14 = r22
            r1.<init>(r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13, r14)     // Catch:{ all -> 0x020f }
            r1 = r17
            okhttp3.internal.concurrent.Task r1 = (okhttp3.internal.concurrent.Task) r1     // Catch:{ all -> 0x020f }
            r3 = r18
            r2 = r20
            r2.schedule(r1, r3)     // Catch:{ all -> 0x020f }
            goto L_0x010f
        L_0x00e5:
            kotlin.TypeCastException r0 = new kotlin.TypeCastException     // Catch:{ all -> 0x020f }
        ...
        L_0x0101:
            ...
            r26 = r14
        L_0x010f:
            kotlin.Unit r1 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x020f }
            monitor-exit(r27)
            r3 = r16
            if (r3 == 0) goto L_0x0124
            r1 = r21
            if (r1 != 0) goto L_0x011d
            kotlin.jvm.internal.Intrinsics.throwNpe()     // Catch:{ all -> 0x01e6 }
        L_0x011d:
            r1.writePong(r3)     // Catch:{ all -> 0x01e6 }
        L_0x0120:
            r1 = r24
            goto L_0x019b
        L_0x0124:
            r1 = r21
            T r2 = r0.element     // Catch:{ all -> 0x01e6 }
            boolean r2 = r2 instanceof okhttp3.internal.ws.RealWebSocket.Message     // Catch:{ all -> 0x01e6 }
            if (r2 == 0) goto L_0x0160
            T r0 = r0.element     // Catch:{ all -> 0x01e6 }
            if (r0 == 0) goto L_0x0158
            okhttp3.internal.ws.RealWebSocket$Message r0 = (okhttp3.internal.ws.RealWebSocket.Message) r0     // Catch:{ all -> 0x01e6 }
            if (r1 != 0) goto L_0x0137
            kotlin.jvm.internal.Intrinsics.throwNpe()     // Catch:{ all -> 0x01e6 }
        L_0x0137:
            int r2 = r0.getFormatOpcode()     // Catch:{ all -> 0x01e6 }
            okio.ByteString r3 = r0.getData()     // Catch:{ all -> 0x01e6 }
            r1.writeMessageFrame(r2, r3)     // Catch:{ all -> 0x01e6 }
            monitor-enter(r27)     // Catch:{ all -> 0x01e6 }
            long r1 = r15.queueSize     // Catch:{ all -> 0x0155 }
            okio.ByteString r0 = r0.getData()     // Catch:{ all -> 0x0155 }
            int r0 = r0.size()     // Catch:{ all -> 0x0155 }
            long r3 = (long) r0     // Catch:{ all -> 0x0155 }
            long r1 = r1 - r3
            r15.queueSize = r1     // Catch:{ all -> 0x0155 }
            kotlin.Unit r0 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0155 }
            monitor-exit(r27)     // Catch:{ all -> 0x01e6 }
            goto L_0x0120
        L_0x0155:
            r0 = move-exception
            monitor-exit(r27)     // Catch:{ all -> 0x01e6 }
        ...
        L_0x0158:
            kotlin.TypeCastException r0 = new kotlin.TypeCastException     // Catch:{ all -> 0x01e6 }
        ...
        L_0x0160:
            T r2 = r0.element     // Catch:{ all -> 0x01e6 }
            boolean r2 = r2 instanceof okhttp3.internal.ws.RealWebSocket.Close     // Catch:{ all -> 0x01e6 }
            if (r2 == 0) goto L_0x01d6
            T r0 = r0.element     // Catch:{ all -> 0x01e6 }
            if (r0 == 0) goto L_0x01c8
            okhttp3.internal.ws.RealWebSocket$Close r0 = (okhttp3.internal.ws.RealWebSocket.Close) r0     // Catch:{ all -> 0x01e6 }
            if (r1 != 0) goto L_0x0171
            kotlin.jvm.internal.Intrinsics.throwNpe()     // Catch:{ all -> 0x01e6 }
        L_0x0171:
            int r2 = r0.getCode()     // Catch:{ all -> 0x01e6 }
            okio.ByteString r0 = r0.getReason()     // Catch:{ all -> 0x01e6 }
            r1.writeClose(r2, r0)     // Catch:{ all -> 0x01e6 }
            r1 = r24
            T r0 = r1.element     // Catch:{ all -> 0x01c2 }
            okhttp3.internal.ws.RealWebSocket$Streams r0 = (okhttp3.internal.ws.RealWebSocket.Streams) r0     // Catch:{ all -> 0x01c2 }
            if (r0 == 0) goto L_0x019b
            okhttp3.WebSocketListener r0 = r15.listener     // Catch:{ all -> 0x01c2 }
            r2 = r15
            okhttp3.WebSocket r2 = (okhttp3.WebSocket) r2     // Catch:{ all -> 0x01c2 }
            r3 = r26
            int r3 = r3.element     // Catch:{ all -> 0x01c2 }
            r4 = r25
            T r4 = r4.element     // Catch:{ all -> 0x01c2 }
            java.lang.String r4 = (java.lang.String) r4     // Catch:{ all -> 0x01c2 }
            if (r4 != 0) goto L_0x0198
            kotlin.jvm.internal.Intrinsics.throwNpe()     // Catch:{ all -> 0x01c2 }
        L_0x0198:
            r0.onClosed(r2, r3, r4)     // Catch:{ all -> 0x01c2 }
        L_0x019b:
            r0 = 1
            T r1 = r1.element
        ...
        L_0x01c8:
            ...
            r2 = r23
            r1 = r24
            kotlin.TypeCastException r0 = new kotlin.TypeCastException     // Catch:{ all -> 0x01e4 }
            java.lang.String r4 = "null cannot be cast to non-null type okhttp3.internal.ws.RealWebSocket.Close"
            r0.<init>(r4)     // Catch:{ all -> 0x01e4 }
            throw r0     // Catch:{ all -> 0x01e4 }
        L_0x01d6:
            r3 = r22
            r2 = r23
            r1 = r24
            java.lang.AssertionError r0 = new java.lang.AssertionError     // Catch:{ all -> 0x01e4 }
            r0.<init>()     // Catch:{ all -> 0x01e4 }
            java.lang.Throwable r0 = (java.lang.Throwable) r0     // Catch:{ all -> 0x01e4 }
            throw r0     // Catch:{ all -> 0x01e4 }
        L_0x01e4:
            r0 = move-exception
            goto L_0x01ed
