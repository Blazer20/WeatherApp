...
public final class RealConnectionPool {
    ...
    public final int idleConnectionCount() {
        ...
        if (!(iterable instanceof Collection) || !((Collection) iterable).isEmpty()) {
            for (RealConnection realConnection : iterable) {
                Intrinsics.checkExpressionValueIsNotNull(realConnection, "it");
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:46:0x0093, code lost:
        if (r10.connections.isEmpty() == false) goto L_0x009a;
     */
    ...
    public final long cleanup(long r11) {
        ...
        L_0x005f:
            monitor-enter(r0)
            java.util.List r1 = r0.getCalls()     // Catch:{ all -> 0x009b }
            java.util.Collection r1 = (java.util.Collection) r1     // Catch:{ all -> 0x009b }
            ...
            return r6
        L_0x0072:
            long r8 = r0.getIdleAtNs$okhttp()     // Catch:{ all -> 0x009b }
            long r8 = r8 + r4
            ...
            return r6
        L_0x007d:
            r0.setNoNewExchanges(r2)     // Catch:{ all -> 0x009b }
            java.util.concurrent.ConcurrentLinkedQueue<okhttp3.internal.connection.RealConnection> r11 = r10.connections     // Catch:{ all -> 0x009b }
            r11.remove(r0)     // Catch:{ all -> 0x009b }
            monitor-exit(r0)
