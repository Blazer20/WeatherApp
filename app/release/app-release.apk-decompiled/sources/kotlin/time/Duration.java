...
public final class Duration implements Comparable<Duration> {
    ...
    public static double m958constructorimpl(double d) {
        return d;
    }

    /* renamed from: div-LRDsOJo  reason: not valid java name */
    public static final double m959divLRDsOJo(double d, double d2) {
        return d / d2;
    }
    ...
    public static final boolean m979isNegativeimpl(double d) {
        return d < ((double) 0);
    }

    /* renamed from: isPositive-impl  reason: not valid java name */
    public static final boolean m980isPositiveimpl(double d) {
        return d > ((double) 0);
    }
    ...
    private static final int m983precisionimpl(double d, double d2) {
        if (d2 < ((double) 1)) {
            return 3;
        }
        if (d2 < ((double) 10)) {
    ...
    public static final double m999unaryMinusimpl(double d) {
        return m958constructorimpl(-d);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public static final double m982plusLRDsOJo(double d, double d2) {
        return m958constructorimpl(d + d2);
    }

    /* renamed from: minus-LRDsOJo  reason: not valid java name */
    public static final double m981minusLRDsOJo(double d, double d2) {
        return m958constructorimpl(d - d2);
    }

    /* renamed from: times-impl  reason: not valid java name */
    public static final double m985timesimpl(double d, int i) {
        double d2 = (double) i;
        Double.isNaN(d2);
        return m958constructorimpl(d * d2);
    }
    ...
    /* renamed from: times-impl  reason: not valid java name */
    public static final double m984timesimpl(double d, double d2) {
        return m958constructorimpl(d * d2);
    }

    /* renamed from: div-impl  reason: not valid java name */
    public static final double m961divimpl(double d, int i) {
        double d2 = (double) i;
        Double.isNaN(d2);
        return m958constructorimpl(d / d2);
    }
    ...
    /* renamed from: div-impl  reason: not valid java name */
    public static final double m960divimpl(double d, double d2) {
        return m958constructorimpl(d / d2);
    }

    /* renamed from: isInfinite-impl  reason: not valid java name */
    public static final boolean m978isInfiniteimpl(double d) {
        return Double.isInfinite(d);
    }

    /* renamed from: isFinite-impl  reason: not valid java name */
    public static final boolean m977isFiniteimpl(double d) {
        return !Double.isInfinite(d) && !Double.isNaN(d);
    }

    /* renamed from: getAbsoluteValue-impl  reason: not valid java name */
    public static final double m964getAbsoluteValueimpl(double d) {
        return m979isNegativeimpl(d) ? m999unaryMinusimpl(d) : d;
    }

    /* renamed from: compareTo-LRDsOJo  reason: not valid java name */
    public static int m957compareToLRDsOJo(double d, double d2) {
        return Double.compare(d, d2);
    }

    /* renamed from: toComponents-impl  reason: not valid java name */
    public static final <T> T m989toComponentsimpl(double d, Function5<? super Integer, ? super Integer, ? super Integer, ? super Integer, ? super Integer, ? extends T> function5) {
        Intrinsics.checkParameterIsNotNull(function5, "action");
        return function5.invoke(Integer.valueOf((int) m966getInDaysimpl(d)), Integer.valueOf(m965getHoursComponentimpl(d)), Integer.valueOf(m973getMinutesComponentimpl(d)), Integer.valueOf(m975getSecondsComponentimpl(d)), Integer.valueOf(m974getNanosecondsComponentimpl(d)));
    }

    /* renamed from: toComponents-impl  reason: not valid java name */
    public static final <T> T m988toComponentsimpl(double d, Function4<? super Integer, ? super Integer, ? super Integer, ? super Integer, ? extends T> function4) {
        Intrinsics.checkParameterIsNotNull(function4, "action");
        return function4.invoke(Integer.valueOf((int) m967getInHoursimpl(d)), Integer.valueOf(m973getMinutesComponentimpl(d)), Integer.valueOf(m975getSecondsComponentimpl(d)), Integer.valueOf(m974getNanosecondsComponentimpl(d)));
    }

    /* renamed from: toComponents-impl  reason: not valid java name */
    public static final <T> T m987toComponentsimpl(double d, Function3<? super Integer, ? super Integer, ? super Integer, ? extends T> function3) {
        Intrinsics.checkParameterIsNotNull(function3, "action");
        return function3.invoke(Integer.valueOf((int) m970getInMinutesimpl(d)), Integer.valueOf(m975getSecondsComponentimpl(d)), Integer.valueOf(m974getNanosecondsComponentimpl(d)));
    }

    /* renamed from: toComponents-impl  reason: not valid java name */
    public static final <T> T m986toComponentsimpl(double d, Function2<? super Long, ? super Integer, ? extends T> function2) {
        Intrinsics.checkParameterIsNotNull(function2, "action");
        return function2.invoke(Long.valueOf((long) m972getInSecondsimpl(d)), Integer.valueOf(m974getNanosecondsComponentimpl(d)));
    }

    /* renamed from: getHoursComponent-impl  reason: not valid java name */
    public static final int m965getHoursComponentimpl(double d) {
        double r2 = m967getInHoursimpl(d);
        double d2 = (double) 24;
        Double.isNaN(d2);
        return (int) (r2 % d2);
    }
    ...
    public static final int m973getMinutesComponentimpl(double d) {
        double r2 = m970getInMinutesimpl(d);
        double d2 = (double) 60;
        Double.isNaN(d2);
        return (int) (r2 % d2);
    }
    ...
    public static final int m975getSecondsComponentimpl(double d) {
        double r2 = m972getInSecondsimpl(d);
        double d2 = (double) 60;
        Double.isNaN(d2);
        return (int) (r2 % d2);
    }
    ...
    public static final int m974getNanosecondsComponentimpl(double d) {
        return (int) (m971getInNanosecondsimpl(d) % 1.0E9d);
    }

    /* renamed from: toDouble-impl  reason: not valid java name */
    public static final double m990toDoubleimpl(double d, TimeUnit timeUnit) {
        Intrinsics.checkParameterIsNotNull(timeUnit, "unit");
        return DurationUnitKt.convertDurationUnit(d, DurationKt.getStorageUnit(), timeUnit);
    }

    /* renamed from: toLong-impl  reason: not valid java name */
    public static final long m993toLongimpl(double d, TimeUnit timeUnit) {
        Intrinsics.checkParameterIsNotNull(timeUnit, "unit");
        return (long) m990toDoubleimpl(d, timeUnit);
    }

    /* renamed from: toInt-impl  reason: not valid java name */
    public static final int m991toIntimpl(double d, TimeUnit timeUnit) {
        Intrinsics.checkParameterIsNotNull(timeUnit, "unit");
        return (int) m990toDoubleimpl(d, timeUnit);
    }

    /* renamed from: getInDays-impl  reason: not valid java name */
    public static final double m966getInDaysimpl(double d) {
        return m990toDoubleimpl(d, TimeUnit.DAYS);
    }

    /* renamed from: getInHours-impl  reason: not valid java name */
    public static final double m967getInHoursimpl(double d) {
        return m990toDoubleimpl(d, TimeUnit.HOURS);
    }

    /* renamed from: getInMinutes-impl  reason: not valid java name */
    public static final double m970getInMinutesimpl(double d) {
        return m990toDoubleimpl(d, TimeUnit.MINUTES);
    }

    /* renamed from: getInSeconds-impl  reason: not valid java name */
    public static final double m972getInSecondsimpl(double d) {
        return m990toDoubleimpl(d, TimeUnit.SECONDS);
    }

    /* renamed from: getInMilliseconds-impl  reason: not valid java name */
    public static final double m969getInMillisecondsimpl(double d) {
        return m990toDoubleimpl(d, TimeUnit.MILLISECONDS);
    }

    /* renamed from: getInMicroseconds-impl  reason: not valid java name */
    public static final double m968getInMicrosecondsimpl(double d) {
        return m990toDoubleimpl(d, TimeUnit.MICROSECONDS);
    }

    /* renamed from: getInNanoseconds-impl  reason: not valid java name */
    public static final double m971getInNanosecondsimpl(double d) {
        return m990toDoubleimpl(d, TimeUnit.NANOSECONDS);
    }

    /* renamed from: toLongNanoseconds-impl  reason: not valid java name */
    public static final long m995toLongNanosecondsimpl(double d) {
        return m993toLongimpl(d, TimeUnit.NANOSECONDS);
    }

    /* renamed from: toLongMilliseconds-impl  reason: not valid java name */
    public static final long m994toLongMillisecondsimpl(double d) {
        return m993toLongimpl(d, TimeUnit.MILLISECONDS);
    }
    ...
    public static java.lang.String m996toStringimpl(double r8) {
        /*
            boolean r0 = m978isInfiniteimpl(r8)
        ...
        L_0x000c:
            ...
            goto L_0x00c0
        L_0x0016:
            double r0 = m964getAbsoluteValueimpl(r8)
            double r0 = m971getInNanosecondsimpl(r0)
        ...
        L_0x008c:
            ...
            goto L_0x002b
        L_0x008f:
            double r2 = m990toDoubleimpl(r8, r0)
        ...
        L_0x00a6:
            ...
            int r8 = m983precisionimpl(r8, r6)
        ...
        L_0x00c0:
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.time.Duration.m996toStringimpl(double):java.lang.String");
    }
    ...
    /* renamed from: toString-impl  reason: not valid java name */
    public static final String m997toStringimpl(double d, TimeUnit timeUnit, int i) {
        String str;
        Intrinsics.checkParameterIsNotNull(timeUnit, "unit");
        if (!(i >= 0)) {
            throw new IllegalArgumentException(("decimals must be not negative, but was " + i).toString());
        } else if (m978isInfiniteimpl(d)) {
            return String.valueOf(d);
        } else {
            double r6 = m990toDoubleimpl(d, timeUnit);
    ...
    public static final String m992toIsoStringimpl(double d) {
        StringBuilder sb = new StringBuilder();
        if (m979isNegativeimpl(d)) {
            sb.append('-');
        }
        sb.append("PT");
        double r7 = m964getAbsoluteValueimpl(d);
        int r1 = (int) m967getInHoursimpl(r7);
        int r2 = m973getMinutesComponentimpl(r7);
        int r3 = m975getSecondsComponentimpl(r7);
        int r72 = m974getNanosecondsComponentimpl(r7);
        boolean z = true;
        boolean z2 = r1 != 0;
